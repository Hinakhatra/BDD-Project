...
public class ShippingMethodPage extends Utils{
    ...
    public void verifyShippingMethodPageURL(){
        Assert.assertEquals(getCurrentURL(),loadProp.getProperty("shippingMethodPageURL"));
    }
    ...
    public void verifyConfirmOrderMessage(){
